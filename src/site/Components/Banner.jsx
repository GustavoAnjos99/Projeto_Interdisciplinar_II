        ...
        <div className="container">
            <div className="row">
                <div className="col-lg-6 info">
                    <h1 className='title'> Um novo conceito de festas para realizar seu sonho!</h1>
                    ...
                    <div className='button__div'>
                        {logado ? (
                                <SecureRoute allowedUserType="cliente" to="/app/cliente/home">
                                    <Link to="/app/cliente/home" className="button">Página Inicial</Link>
                                </SecureRoute>
                            ) : (
                                <>
                                    <Link to="/app/novaconta" className="button">Criar Conta</Link>
                                    <Link to="/app/login" className="button">Fazer Login</Link>
                                </>
                            )}
                    </div>

    ...
    <div className="d-flex align-items-center text-center form-container">
      <form className="cont form-signin">
          ...
          <div className="form-floating">
            ...
            <input onChange={(e) => setEmail(e.target.value)} type="email" className="form-control" id="floatingInput" placeholder="Digite o e-mail cadastrado..." />
        </div>
  
        <button onClick={recuperarSenha} className="w-100 btn btn-lg btn-primary mt-3 submit" type="button">Enviar</button>

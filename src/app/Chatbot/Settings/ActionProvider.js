class ActionProvider {
  ...
  handleBuffet = () => {
    const message = this.createChatBotMessage(
      "Nosso Buffet completo oferece doces, salgados, bolo, mini anches e muito mais! Para adquirir esse pacote de serviços entre em contato!",
      {
        widget: "suboptions",
  ...
  handleTiposBolos = () => {
    const message = this.createChatBotMessage(
      `Delicioso! Você escolheu os seguintes tipos de bolos: ${this.selectedSuboptions.join(", ")}. Agora escolha a quantidade necessária para os itens escolhidos.`,
      {
        widget: "quantidade",
      }
    )

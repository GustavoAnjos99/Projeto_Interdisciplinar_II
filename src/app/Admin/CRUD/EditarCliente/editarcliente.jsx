...
function EditarCliente(props){
    ...
    useEffect(() => {
        firebase.firestore().collection('usuarios').doc(props.match.params.id).get().then((resultado) => {
    ...
    function AlterarCliente(){
      ...
      if (nome.length === 0){
        ...
        setMensagem('Informe o número');
          ...
          db.collection('usuarios').doc(props.match.params.id).update({
            nome: nome,
            email: email,
            telefone: telefone,
            cep: cep,
          ...
          <div className="offset-lg-3 col-lg-6">
            ...
            <form>
              ...
              <div className="mb-3">
                ...
                <input  onChange={(e) => setTelefone(e.target.value)} value={telefone} type="text" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" />              
              </div>
              
              <div className="mb-3">
                <label htmlFor="exampleInputEmail1" className="form-label">CEP</label>
                <input  onChange={(e) => setTelefone(e.target.value)} value={cep} type="text" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" />              
              </div>

              <div className="text-center">
                <Link to="/app/admin/home" className="btn btn-outline-primary btn-acao">Cancelar</Link>
                <button onClick={AlterarCliente} type="button" className="btn btn-primary btn-acao submit">Salvar</button>
              </div>

...
function NovoCliente(){
    ...
    return <div>
        ...
        <div className="container-fluid">
          ...
          <p>Deseja adicionar um cliente manualmente? Insira os dados e clique em salvar!</p>
            <form>
              <div className="mb-3">
              ...
              <div className="text-center">
                <Link to="/app/admin/home" className="btn btn-outline-primary btn-acao cancel">Cancelar</Link>
                <button onClick={CadastrarCliente} type="button" className="btn btn-primary btn-acao submit">Salvar</button>
              </div>
